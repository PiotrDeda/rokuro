...
public static class Drawer
{
	...
	public static void Draw(Sprite sprite, Vector2I position, float scale) => DrawerImpl.ActiveImpl.DrawSprite(sprite, position, scale);
	public static void DrawPoint(Vector2I position, Color color) => DrawerImpl.ActiveImpl.DrawPoint(position, color);
	public static void DrawLine(Vector2I start, Vector2I end, Color color, int thickness) => DrawerImpl.ActiveImpl.DrawLine(start, end, color, thickness);
	public static void DrawRect(Vector2I position, Vector2I size, Color color) => DrawerImpl.ActiveImpl.DrawRect(position, size, color);
	public static void DrawCircle(Vector2I position, int radius, Color color) => DrawerImpl.ActiveImpl.DrawCircle(position, radius, color);

	internal static IntPtr GetTextRawTexture(string text, Font font, Color color) => DrawerImpl.ActiveImpl.GetTextRawTexture(text, font, color);
